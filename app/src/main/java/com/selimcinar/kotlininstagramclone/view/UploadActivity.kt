...
import com.selimcinar.kotlininstagramclone.databinding.ActivityUploadBinding
...
class UploadActivity : AppCompatActivity() {
    ...
    fun uploadActivity (view: View) {
        ...
        if (selectedPicture != null) {
            imagesReference.putFile(selectedPicture!!).addOnSuccessListener { taskSnapshot ->
                ...
                uploadedPictureReference.downloadUrl.addOnSuccessListener { uri ->
                    ...
                    db.collection( "Posts").add(postMap).addOnCompleteListener{task ->
                        ...
                        Log.e("Firebase", "Hata: ${exception.message}", exception)
            ...
            Toast.makeText(applicationContext,"hata resimde",Toast.LENGTH_LONG).show()
